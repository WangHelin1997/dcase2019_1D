...
from utilities import (create_folder, get_filename, create_logging, load_scalar,
                       get_subdir, get_sources)
from data_generator_plus import DataGenerator
from models_plus import Cnn_9layers_AvgPooling, Cnn_9layers_MaxPooling
...
def train(args):
    ...
    for batch_data_dict, batch_data_dict_left, batch_data_dict_right, batch_data_dict_side in data_generator.generate_train():
        ...
        # Train
        model.train()
        batch_output = model(data=batch_data_dict['feature'], data_left=batch_data_dict_left['feature_left'],
